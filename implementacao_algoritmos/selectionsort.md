...
No arquivo [`selectionsort.cpp`](selectionsort.cpp) temos um exemplo de método de ordenação (ordenação por seleção), a seguir irei explicar o funcionamento desse algoritmo.
